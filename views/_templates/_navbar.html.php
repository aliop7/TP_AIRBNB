        ...
        <div class="container-fluid d-flex align-items-baseline ">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-end z-i">
                    ...
                    <?php else: ?>
                        <li><a href="/test" class="dropdown-item">Sign up</a></li>
                        <li><a href="/test" class="dropdown-item">Log in</a></li>
                    <?php endif; ?>

                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><button class="dropdown-item" type="button">Gift Cards</button></li>
                    <li><button class="dropdown-item" type="button">Airbnb your home</button></li>
                    <li><button class="dropdown-item" type="button">Help center</button></li>
                    <hr class="dropdown-divider">
                    <?php if (Session::get(Session::USER)): ?>
